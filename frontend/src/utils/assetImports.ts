...
const recursoConociendoCerebroMP4 = new URL(
  '../assets/videos/recurso-conociendo-el-cerebro.mp4',
  import.meta.url
).href;

const videoBienvenidaMP4 = new URL(
  '../assets/videos/video-bienvenida.mp4',
  import.meta.url
).href;
...
const cerebroAprendeEmocion = new URL(
  '../assets/diapositivas/cerebro-aprende-emocion.pptx',
  import.meta.url
).href;
...
export const assets = {
  ...
  videos: {
    recursoConociendoCerebro: recursoConociendoCerebroMP4,
    videoBienvenida: videoBienvenidaMP4,
  },
  ...
  pptx: {
    ...
    cerebroAprendeEmocion: cerebroAprendeEmocion,
  }
};